...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("EgoMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("EgoMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("EgoMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("EgoMusic/assets/play_icons.png")
