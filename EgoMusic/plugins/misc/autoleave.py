...
from EgoMusic.core.call import Ego, autoend, counter
from EgoMusic.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave
import logging
    ...
    while True:
        ...
        try:
            ...
            for chat_id in chatss:
                try:
                    users = len(await Ego.call_listeners(chat_id))
